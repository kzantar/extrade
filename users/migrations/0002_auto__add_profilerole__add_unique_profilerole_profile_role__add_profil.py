...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProfileRole'
        db.create_table(u'users_profilerole', (
        ...
        db.send_create_signal(u'users', ['ProfileRole'])

        # Adding unique constraint on 'ProfileRole', fields ['profile', 'role']
        db.create_unique(u'users_profilerole', ['profile_id', 'role'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'ProfileRole', fields ['profile', 'role']
        db.delete_unique(u'users_profilerole', ['profile_id', 'role'])

        # Deleting model 'ProfileRole'
        db.delete_table(u'users_profilerole')
