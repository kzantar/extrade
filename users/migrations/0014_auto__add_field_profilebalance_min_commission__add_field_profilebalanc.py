...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileBalance.min_commission'
        db.add_column(u'users_profilebalance', 'min_commission',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=14, decimal_places=8),
                      keep_default=False)

        # Adding field 'ProfileBalance.max_commission'
        db.add_column(u'users_profilebalance', 'max_commission',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=14, decimal_places=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileBalance.min_commission'
        db.delete_column(u'users_profilebalance', 'min_commission')

        # Deleting field 'ProfileBalance.max_commission'
        db.delete_column(u'users_profilebalance', 'max_commission')
