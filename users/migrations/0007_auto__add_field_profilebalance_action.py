...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileBalance.action'
        db.add_column(u'users_profilebalance', 'action',
                      self.gf('django.db.models.fields.CharField')(default='+', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileBalance.action'
        db.delete_column(u'users_profilebalance', 'action')
