...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileBalance.paymethod'
        db.add_column(u'users_profilebalance', 'paymethod',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['currency.PaymentMethod']),
                      keep_default=False)


        # Changing field 'ProfileBalance.bank'
        db.alter_column(u'users_profilebalance', 'bank', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

    def backwards(self, orm):
        # Deleting field 'ProfileBalance.paymethod'
        db.delete_column(u'users_profilebalance', 'paymethod_id')


        # Changing field 'ProfileBalance.bank'
        db.alter_column(u'users_profilebalance', 'bank', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
