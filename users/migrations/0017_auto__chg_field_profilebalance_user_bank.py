...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProfileBalance.user_bank'
        db.alter_column(u'users_profilebalance', 'user_bank', self.gf('django.db.models.fields.TextField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'ProfileBalance.user_bank'
        db.alter_column(u'users_profilebalance', 'user_bank', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
