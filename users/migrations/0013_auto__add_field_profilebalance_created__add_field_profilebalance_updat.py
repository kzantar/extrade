...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileBalance.created'
        db.add_column(u'users_profilebalance', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'ProfileBalance.updated'
        db.add_column(u'users_profilebalance', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileBalance.created'
        db.delete_column(u'users_profilebalance', 'created')

        # Deleting field 'ProfileBalance.updated'
        db.delete_column(u'users_profilebalance', 'updated')
