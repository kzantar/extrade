...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileBalance.commission'
        db.add_column(u'users_profilebalance', 'commission',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileBalance.commission'
        db.delete_column(u'users_profilebalance', 'commission')
