...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileBalance.user_bank'
        db.add_column(u'users_profilebalance', 'user_bank',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileBalance.user_bank'
        db.delete_column(u'users_profilebalance', 'user_bank')
    ...
    models = {
        ...
        u'users.profilebalance': {
            ...
            'user_bank': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
