...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfileBalance.bank'
        db.add_column(u'users_profilebalance', 'bank',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProfileBalance.accept'
        db.add_column(u'users_profilebalance', 'accept',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfileBalance.bank'
        db.delete_column(u'users_profilebalance', 'bank')

        # Deleting field 'ProfileBalance.accept'
        db.delete_column(u'users_profilebalance', 'accept')
