...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentMethod.description_bank'
        db.add_column(u'currency_paymentmethod', 'description_bank',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentMethod.description_bank'
        db.delete_column(u'currency_paymentmethod', 'description_bank')
