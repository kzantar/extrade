...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentMethod.disable'
        db.add_column(u'currency_paymentmethod', 'disable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentMethod.disable'
        db.delete_column(u'currency_paymentmethod', 'disable')
