...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentMethod.min_commission'
        db.add_column(u'currency_paymentmethod', 'min_commission',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=14, decimal_places=8),
                      keep_default=False)

        # Adding field 'PaymentMethod.max_commission'
        db.add_column(u'currency_paymentmethod', 'max_commission',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=14, decimal_places=8),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentMethod.min_commission'
        db.delete_column(u'currency_paymentmethod', 'min_commission')

        # Deleting field 'PaymentMethod.max_commission'
        db.delete_column(u'currency_paymentmethod', 'max_commission')
