...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PaymentMethod.enable_account_number'
        db.add_column(u'currency_paymentmethod', 'enable_account_number',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PaymentMethod.enable_account_number'
        db.delete_column(u'currency_paymentmethod', 'enable_account_number')
    ...
    models = {
        u'currency.paymentmethod': {
            ...
            'enable_account_number': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
